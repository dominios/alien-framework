...
INSERT INTO `test_content_items` VALUES (1,NULL,NULL,'TextItem','skuska','hello world!');
...
CREATE TABLE `test_content_pages` (
  `id` int(8) unsigned NOT NULL AUTO_INCREMENT,
  `template` int(8) unsigned NOT NULL,
  `folder` int(8) DEFAULT NULL,
  `name` varchar(50) NOT NULL,
  ...
  KEY `FK_PAGE_TEMPLATE` (`template`),
  CONSTRAINT `FK_PAGE_TEMPLATE` FOREIGN KEY (`template`) REFERENCES `test_content_templates` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `test_content_pages` VALUES (1,3,3,'uvod','uvod','abcdefghijklô','',NULL);
...
INSERT INTO `test_content_template_blocks` VALUES (4,'footer'),(3,'main'),(2,'slider'),(1,'topmenu');
...
CREATE TABLE `test_content_templates` (
  `id` int(8) unsigned NOT NULL AUTO_INCREMENT,
  `folder` int(8) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `test_content_templates` VALUES (1,1,'uvod','uvodna stranka','templates/uvod.php'),(2,1,'stranka','sablona pre podstranky','templates/stranka.php'),(3,1,'basic','testovacia sablona','templates/basic.php');
...
CREATE TABLE `test_content_widgets` (
  ...
  CONSTRAINT `FK_WIDGET_PAGE` FOREIGN KEY (`page`) REFERENCES `test_content_pages` (`id`) ON DELETE SET NULL,
  CONSTRAINT `FK_WIDGET_TEMPLATE` FOREIGN KEY (`template`) REFERENCES `test_content_templates` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `test_content_widgets` VALUES (1,NULL,NULL,1,3,'CodeItemWidget',1,1,NULL,'widgets/CodeItem/CodeItem.php','a:1:{s:4:\"text\";s:5:\"hello\";}'),(2,NULL,NULL,1,2,'CodeItemWidget',1,1,NULL,'widgets/CodeItem/testTemplate.phtml','a:1:{s:4:\"text\";s:13:\"hello world !\";}'),(3,NULL,NULL,1,2,'CodeItemWidget',1,1,NULL,'widgets/CodeItem/CodeItem.php','a:1:{s:4:\"text\";s:3:\"!!!\";}'),(4,NULL,NULL,1,2,'TextItemWidget',1,1,NULL,'widgets/TextItem/default.php','a:1:{s:4:\"text\";s:3:\"!!!\";}');
...
INSERT INTO `test_users` VALUES (1,'admin','$2y$11$ZDzHXXOCfYowb1GTEivGOuzlTBuPcAGV7OhZp.rdoCl6ikylw5G36','admin@alien.com',1366410325,1,1394974039,0,0,'Dominik','Geršák'),(2,'moderator','$2y$11$6xfw.ZNzsyfBSD4Fs9cTnu/dCWZgDB8ZP9p0fn9OA9OYRTI9IUNSO','moderator@alien.com',1366410325,1,1386510200,0,0,'ferko','mkrvicka'),(4,'test','f91f3eed5bbf0eec3e4737e13c867a12d6ac1d47','',1383599330,0,NULL,0,1,'meno','priezvisko');
...
-- Dump completed on 2014-03-16 13:49:46
