        ...
        <section id="container">
            ...
            <form method="POST" action="index.php">
                ...
                <table>
                    ...
                    <tr><td><input type="submit" name="loginFormSubmit" value="Sign in"</td></tr>
                </table>
            </form>
        </section>

        <footer>
            ALiEN CMS | © 2013 <a href="mailto: domgersak@gmail.com" target="_blank">Dominik Geršák</a>, všetky práva vyhradené | optmimalizované pre 1366x768+ 32bit
        </footer>
    </body>