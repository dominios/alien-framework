...
//    private $permissions;
    ...
    public function actionGoTo() {
        return BaseController::actionURL('content', 'browser', array('folder' => $this->id));
    }

    public function actionEdit() {
        return BaseController::actionURL('content', 'editFolder', array('id' => $this->id));
    }
...
//                else $this->items[]=$item;
    ...
    public function getParent($fetch = false) {
        ...
        $STH->execute();
        $result = $STH->fetch();
        return $fetch ? new Folder(null, $result) : $result['id_f'];
    }
